...
export async function generateStaticParams() {
  try {
    console.log("Generating static paths for generate-video...");
    ...
    return projects.map((project) => ({
      pathname: project, // Pre-builds /[pathname]/generate-video
    }));
  } catch (error) {
    Sentry.captureException(
      "Error fetching static paths for generate-video:",
      error
    );
    console.error("Error fetching static paths for generate-video:", error);
    return [];
  }
}
